...
func TaskSortHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.TaskSortReq
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := task.NewTaskSortLogic(r.Context(), svcCtx)
		resp, err := l.TaskSort(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
