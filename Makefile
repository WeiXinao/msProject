...
modelgen:
	@.\pkg\model_generator\bin\modelgen.exe model --dsn 'root:123456@tcp(192.168.5.4:3307)/ms_project?charset=utf8' --table ms_project_member --dst .\project\internal\repo\dao\types.go
