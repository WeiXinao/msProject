...
modelgen:
	@./pkg/model_generator/bin/modelgen model --dsn 'root:123456@tcp(127.0.0.1:3307)/ms_project?charset=utf8' --table ms_task_stages --dst ./task/internal/repo/dao/types.go
