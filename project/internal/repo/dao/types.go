...
type Project struct {
	...
	TemplateCode       string  `xorm:"'template_code' varchar(30) null default('') comment('项目类型')"`
	Schedule           float64 `xorm:"'schedule' double(5,2) null default(0.00) comment('进度')"`
	CreateTime         string  `xorm:"'create_time' varchar(255) null default(null) comment('创建时间')"`
